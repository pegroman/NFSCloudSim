...
/*
 * Title: Ejemplo que corre ejecuta read!      
 */
 ...
 * one cloudlet on it.
 */
public class CloudSimExample10NodesRead {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CloudSim.send(vm2.getIdFs(), vm2.getIdFs(), 84 + 0.1, SistemaArchivos.CREAR_FSBASICO, null);
            CloudSim.send(vm3.getIdFs(), vm3.getIdFs(), 84 + 0.2, SistemaArchivos.CREAR_FSBASICO, null);
            CloudSim.send(vm4.getIdFs(), vm4.getIdFs(), 84 + 0.3, SistemaArchivos.CREAR_FSBASICO, null);
            ...
            CloudSim.send(vm3.getIdFs(), vm.getClient_list().get(2).getIdVfs(), 87 + 0.5, VirtualFileSystem.MOUNT, vm.getSharedDir());
            CloudSim.send(vm4.getIdFs(), vm.getClient_list().get(3).getIdVfs(), 87 + 0.75, VirtualFileSystem.MOUNT, vm.getSharedDir());
            ...
            CloudSim.send(vm.getRpc().getId(), vm.getRpc().getId(), 87.80, Rpc.CLIENT_LIST, vm.getClient_list());

            //Ejecuto IOR, en cliente. El tipo de operacion es read
            //Object[] parametros = {"READ", 256.00, 256.00, 4, "LINEAL"}; // 0->operación; 1->bsize; 2->tsize; 3->scount; 4->regresion
            //Object[] parametros = {"READ", 256.00, 256.00, 4, "EXPONENCIAL"}; // 0->operación; 1->bsize; 2->tsize; 3->scount; 4->regresion
            //Object[] parametros = {"READ", 512.00, 512.00, 4, "EXPONENCIAL"};
            //Object[] parametros = {"READ", 512.00, 512.00, 4, "LINEAL"};
            //Object[] parametros = {"READ", 512.00, 512.00, 6, "EXPONENCIAL"};
            //Object[] parametros = {"READ", 512.00, 512.00, 6, "LINEAL"};
            //Object[] parametros = {"READ", 512.00, 512.00, 8, "EXPONENCIAL"};
            //Object[] parametros = {"READ", 512.00, 512.00, 8, "LINEAL"};
            //Object[] parametros = {"READ", 256.00, 256.00, 6, "LINEAL"}; //1.5GB
            //Object[] parametros = {"READ", 512.00, 512.00, 5, "LINEAL"}; //2.5GB
            Object[] parametros = {"READ", 512.00, 512.00, 7, "LINEAL"}; //3.5GB
